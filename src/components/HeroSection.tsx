...
const HeroSection = () => {
  ...
  return (
    <div className="my-5 w-full">
      <div className="container block max-w-6xl flex-col gap-px overflow-hidden md:flex md:h-[400px] md:flex-row">
        <div className="mb-2 h-full w-full md:mb-0 md:w-1/2">
          {renderHeroSectionItem(0, 1)}
        </div>

        <div className="flex h-full w-full flex-col gap-px md:w-1/2">
          <div className="h-1/2 w-full ">{renderHeroSectionItem(1, 2)}</div>
          <div className="flex h-1/2 w-full flex-col gap-px md:flex-row">
