...
const HeroSection = () => {
  ...
  return (
    <div className="my-5 w-full">
      <div className="container block max-w-6xl flex-col gap-3 overflow-hidden md:flex md:h-[400px] md:flex-row">
        ...
        <div className="flex h-full w-full flex-col gap-3 md:w-1/2">
          ...
          <div className="flex h-1/2 w-full flex-col gap-3 md:flex-row">
